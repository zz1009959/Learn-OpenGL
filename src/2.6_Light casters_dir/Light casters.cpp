...
int main()
{
	...
	Shader lightCubeShader("./src/2.6_Light casters_dir/shader/light_object_vs.vert", "./src/2.6_Light casters_dir/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.6_Light casters_dir/shader/cube_vs.vert", "./src/2.6_Light casters_dir/shader/cube_fs.frag");
