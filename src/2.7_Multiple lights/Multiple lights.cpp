...
int main()
{
	...
	Shader lightCubeShader("./src/2.7_Multiple lights/shader/light_object_vs.vert", "./src/2.7_Multiple lights/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.7_Multiple lights/shader/cube_vs.vert", "./src/2.7_Multiple lights/shader/cube_fs.frag");
