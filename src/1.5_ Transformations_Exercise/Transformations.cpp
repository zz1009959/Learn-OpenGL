...
int main()
{
	...
	Shader ourShader("./src/1.5_ Transformations_Exercise/shader/vertexShader.vert", "./src/1.5_ Transformations_Exercise/shader/fragmentShader.frag");
	...
	rotateAngle = glfwGetTime();
	ourShader.setFloat("rotateAngle", rotateAngle);
