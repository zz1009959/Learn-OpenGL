...
int main()
{
	...
	Shader lightCubeShader("./src/2.4_Materials_Exc/shader/light_object_vs.vert", "./src/2.4_Materials_Exc/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.4_Materials_Exc/shader/cube_vs.vert", "./src/2.4_Materials_Exc/shader/cube_fs.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//改变光照立方体的颜色
		lightCubeShader.use();
		lightCubeShader.setVec3("lightColor1", lightColor);
