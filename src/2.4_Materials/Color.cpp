...
int main()
{
	...
	Shader lightCubeShader("./src/2.4_Materials/shader/light_object_vs.vert", "./src/2.4_Materials/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.4_Materials/shader/cube_vs.vert", "./src/2.4_Materials/shader/cube_fs.frag");
