...
int main()
{
	...
	Shader lightCubeShader("./src/2.2_Basic Lighting/shader/light_object_vs.vert", "./src/2.2_Basic Lighting/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.2_Basic Lighting/shader/cube_vs.vert", "./src/2.2_Basic Lighting/shader/cube_fs.frag");
