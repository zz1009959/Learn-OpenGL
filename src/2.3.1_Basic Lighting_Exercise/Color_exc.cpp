...
int main()
{
	...
	Shader lightCubeShader("./src/2.3.1_Basic Lighting_Exercise/shader/light_object_vs.vert", "./src/2.3.1_Basic Lighting_Exercise/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.3.1_Basic Lighting_Exercise/shader/cube_vs.vert", "./src/2.3.1_Basic Lighting_Exercise/shader/cube_fs.frag");
