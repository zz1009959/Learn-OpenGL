...
int main()
{
	...
	Shader lightCubeShader("./src/2.1_Color/shader/light_object.vert", "./src/2.1_Color/shader/light_object.frag");
	Shader lightingShader("./src/2.1_Color/shader/vertexShader.vert", "./src/2.1_Color/shader/fragmentShader.frag");
