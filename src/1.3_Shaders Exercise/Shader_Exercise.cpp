...
int main()
{
	...
	Shader ourShader("./src/1.3_Shaders Exercise/shader/vertexShader.vert", "./src/1.3_Shaders Exercise/shader/fragmentShader.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//使用着色器
		ourShader.use();
		ourShader.setFloat("right",rightMoveValue);
