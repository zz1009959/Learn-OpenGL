...
int main()
{
	...
	Shader lightCubeShader("./src/2.3.2_Basic Lighting_Exercise2/shader/light_object_vs.vert", "./src/2.3.2_Basic Lighting_Exercise2/shader/light_object_fs.frag");
	Shader lightingShader("./src/2.3.2_Basic Lighting_Exercise2/shader/cube_vs.vert", "./src/2.3.2_Basic Lighting_Exercise2/shader/cube_fs.frag");
